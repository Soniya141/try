...
WebUI.sendKeys(findTestObject('Object Repository/micro staging/Page_Olay Holiday Program/input__mat-input-6'), 'testing3145@yopmail.com')

WebUI.sendKeys(findTestObject('Object Repository/micro staging/Page_Olay Holiday Program/input__mat-input-7'), 'testing3145@yopmail.com')
...
//WebUI.click(findTestObject('Object Repository/micro staging/Page_Olay Holiday Program/div_id(katalon-rec_elementInfoDiv)'))
//WebUI.click(findTestObject('Object Repository/micro staging/Page_Olay Holiday Program/img_traffic lights_rc-image-tile-44'))
//WebUI.click(findTestObject('Object Repository/micro staging/Page_Olay Holiday Program/img_traffic lights_rc-image-tile-44'))
//WebUI.click(findTestObject('Object Repository/micro staging/Page_Olay Holiday Program/button_Verify'))
